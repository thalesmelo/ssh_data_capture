...
public class NewsBean {
	...
	private Integer BlogId=WebSiteConfig.WEB_MODULE==WebModule.NEWS?1:2;
	...
	public String toString() {
		return "NewsBean [newsUrl=" + newsUrl + ", commonUrl=" + commonUrl + ", replyUrl=" + replyUrl + ", Id=" + Id
				+ ", Title=" + Title + ", FeaturedImageUrl=" + FeaturedImageUrl + ", Teaser=" + Teaser + ", ImageUrl="
				+ ImageUrl + ", DocumentUrl=" + DocumentUrl + ", Tag=" + Tag + ", Status=" + Status + ", LoveNum="
