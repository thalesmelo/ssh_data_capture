...
public class AlbumBean {
	...
	public String toString() {
		return "AlbumBean [Id=" + Id + ", UUID=" + UUID + ", CreateDateTime=" + CreateDateTime + ", IsDeleted="
				+ IsDeleted + ", Title=" + Title + ", Description=" + Description + ", Tag=" + Tag + ", VisibleLevel="
				+ VisibleLevel + ", VisibleLevelName=" + VisibleLevelName + ", Contribute=" + Contribute + ", Userid="
				+ Userid + ", Type=" + Type + ", Position=" + Position + ", WebsiteName=" + WebsiteName + "]";
	}
