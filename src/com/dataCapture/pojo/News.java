...
//	private String Tag;
	...
	*//**
	...
	/**
	 * @param lovaNum the lovaNum to set
	 */
	...
	public String toString() {
		return "News [Id=" + Id + ", Title=" + Title + ", FeaturedImageUrl=" + FeaturedImageUrl + ", Teaser=" + Teaser
				+ ", ImageUrl=" + ImageUrl + ", DocumentUrl=" + DocumentUrl  + ", Status=" + Status
				+ ", LovaNum=" + LoveNum + ", ViewNum=" + ViewNum + ", CreateDateTime=" + CreateDateTime
				+ ", IsDeleted=" + IsDeleted + ", CreateUserId=" + CreateUserId + ", Scheduled=" + Scheduled
				+ ", ScheduledDate=" + ScheduledDate + ", VisibleLevelName=" + VisibleLevelName + ", ModifyDateTime="
				+ ModifyDateTime + ", BlogId=" + BlogId + ", VisibleLevel=" + VisibleLevel + ", UUID=" + UUID
				+ ", Feature=" + Feature + ", OrderId=" + OrderId + ", isLock=" + isLock + ", WebsiteName="
				+ WebsiteName + ", Body=" + Body + "]";
	}
