...
public class Users {
	...
	public String toString() {
		return "Users [Id=" + Id + ", UUID=" + UUID + ", CreateDateTime=" + CreateDateTime + ", IsDeleted=" + IsDeleted
				+ ", LoginName=" + LoginName + ", RealName=" + RealName + ", Email=" + Email + ", Password=" + Password
				+ ", Status=" + Status + ", UserGroupId=" + UserGroupId + ", UserRoleId=" + UserRoleId
